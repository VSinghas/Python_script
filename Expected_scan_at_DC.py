...
if __name__ == "__main__":
        ...
        facility = 'Lucknow_Hajipur_DC_Uttar_Pradesh'
        # Selecting specific center to doing the analysis
        scan = scan.select(facility)

        # Storing the mean scan in dataframe
        scan_mean  = pd.read_csv("/disk1/hdf_data/facilities/Lucknow_Hajipur_DC_Uttar_Pradesh/Lucknow_Hajipur_DC_Uttar_Pradesh_means.csv")
        ...
        #in_ship.to_csv("/disk1/vishwa_work/Pjt2/data1/Kodaikanal_Athithnr_DC_Tamil_Nadu/exptd_DCscan.csv")
        #actual_scan.to_csv("/disk1/vishwa_work/Pjt2/data1/Kodaikanal_Athithnr_DC_Tamil_Nadu/actual_DCscan.csv"")
